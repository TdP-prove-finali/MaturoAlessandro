...
public class TestModel {
	...
	public static void main(String[] args) {
		...
		Footballer f2 = model.getFootballerByNumber(9);
		...
		for(Footballer f: footballers2) {
			System.out.println(f);
		}
		
		/*System.out.println("Average and tot part:");
		
		System.out.println("Tot value: "+model.totValue("Juventus"));
		System.out.println("Average age: "+model.averageAge("Juventus"));
		System.out.println("Average wage: "+model.averageWage("Juventus"));
		System.out.println("Average mar: "+model.averageMar("Juventus"));
		System.out.println("Average pas: "+model.averagePas("Juventus"));
